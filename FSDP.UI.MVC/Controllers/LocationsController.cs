...
namespace FSDP.UI.MVC.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LocationId,City,State,ManagerId")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LocationId,City,State,ManagerId")] Location location)
        {
            if (ModelState.IsValid)
            {
